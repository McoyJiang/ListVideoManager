...
import com.mcoy_jiang.videomanager.MessagesHandlerThread;
import com.mcoy_jiang.videomanager.PlayerMessageState;
import com.mcoy_jiang.videomanager.SetNewViewForPlayback;
import com.mcoy_jiang.videomanager.meta.MetaData;
import com.mcoy_jiang.videomanager.player_messages.ClearPlayerInstance;
import com.mcoy_jiang.videomanager.player_messages.CreateNewPlayerInstance;
import com.mcoy_jiang.videomanager.player_messages.PlayerMessage;
import com.mcoy_jiang.videomanager.player_messages.Prepare;
import com.mcoy_jiang.videomanager.player_messages.Release;
import com.mcoy_jiang.videomanager.player_messages.Reset;
import com.mcoy_jiang.videomanager.player_messages.SetAssetsDataSourceMessage;
import com.mcoy_jiang.videomanager.player_messages.SetUrlDataSourceMessage;
import com.mcoy_jiang.videomanager.player_messages.Start;
import com.mcoy_jiang.videomanager.player_messages.Stop;
...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
    ...
    private static SingleVideoPlayerManager singleVideoPlayerManager;
    ...
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, String videoUrl) {
        if(SHOW_LOGS) Logger.v(TAG, ">> playNewVideo, videoPlayer " + videoPlayerView + ", mCurrentPlayer " + mCurrentPlayer);
